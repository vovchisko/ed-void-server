...
const tracks = [
    ...
    },
    {
        ...
        vehicle: 'SRV',
        points: [
            {goal: DGOAL.SURFACE, lat: -28.1848, lon: -14.2108, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'start!'},
            {goal: DGOAL.SURFACE, lat: -28.1834, lon: -14.2143, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'drag!'},
            {goal: DGOAL.SURFACE, lat: -28.1822, lon: -14.2139, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'drift right!'},
            {goal: DGOAL.SURFACE, lat: -28.1824, lon: -14.2150, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'left'},
            {goal: DGOAL.SURFACE, lat: -28.1831, lon: -14.2159, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'storage yard aplpha'},
            {goal: DGOAL.SURFACE, lat: -28.1823, lon: -14.2178, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'corner - keep clear!'},
            {goal: DGOAL.SURFACE, lat: -28.1807, lon: -14.2155, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'egres means exit'},
            {goal: DGOAL.SURFACE, lat: -28.1781, lon: -14.2173, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'left to large pad'},
            {goal: DGOAL.SURFACE, lat: -28.1752, lon: -14.2199, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'run with obstacles'},
            {goal: DGOAL.SURFACE, lat: -28.1738, lon: -14.2187, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'right and keep clear'},
            {goal: DGOAL.SURFACE, lat: -28.1754, lon: -14.2165, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'another exit on left'},
            {goal: DGOAL.SURFACE, lat: -28.1745, lon: -14.2134, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'central yard'},
            {goal: DGOAL.SURFACE, lat: -28.1752, lon: -14.2125, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'shopping time!'},
            {goal: DGOAL.SURFACE, lat: -28.1766, lon: -14.2130, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'wo wow!'},
            {goal: DGOAL.SURFACE, lat: -28.1776, lon: -14.2127, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'look! drones everywhere'},
            {goal: DGOAL.SURFACE, lat: -28.1785, lon: -14.2126, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'nothing interesting here'},
            {goal: DGOAL.SURFACE, lat: -28.1794, lon: -14.2122, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'prepear to drag'},
            {goal: DGOAL.SURFACE, lat: -28.1799, lon: -14.2109, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'drift left'},
            {goal: DGOAL.SURFACE, lat: -28.1761, lon: -14.2088, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'unstopable!!!'},
            {goal: DGOAL.SURFACE, lat: -28.1734, lon: -14.2085, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'dusty corner'},
            {goal: DGOAL.SURFACE, lat: -28.1710, lon: -14.2102, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'small pad'},
            {goal: DGOAL.SURFACE, lat: -28.1682, lon: -14.2132, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'mad max stye!'},
            {goal: DGOAL.SURFACE, lat: -28.1646, lon: -14.2073, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'anti-aircraft platform'},
            {goal: DGOAL.SURFACE, lat: -28.1679, lon: -14.2066, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'what a huge radar!'},
            {goal: DGOAL.SURFACE, lat: -28.1693, lon: -14.2054, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'medium pad'},
            {goal: DGOAL.SURFACE, lat: -28.1694, lon: -14.2035, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'corner'},
            {goal: DGOAL.SURFACE, lat: -28.1731, lon: -14.2034, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'woooosh to another corner!'},
            {goal: DGOAL.SURFACE, lat: -28.1733, lon: -14.2054, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'to the gate!'},
            {goal: DGOAL.SURFACE, lat: -28.1747, lon: -14.2054, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'second pad'},
            {goal: DGOAL.SURFACE, lat: -28.1748, lon: -14.2035, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'left to the corner'},
            {goal: DGOAL.SURFACE, lat: -28.1780, lon: -14.2035, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'yes, next corner, again'},
            {goal: DGOAL.SURFACE, lat: -28.1783, lon: -14.2055, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'to the gate'},
            {goal: DGOAL.SURFACE, lat: -28.1833, lon: -14.2054, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'second run with obstacles'},
            {goal: DGOAL.SURFACE, lat: -28.1840, lon: -14.2064, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'to the storage yard'},
            {goal: DGOAL.SURFACE, lat: -28.1861, lon: -14.2054, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'what\'s in the corner?'},
            {goal: DGOAL.SURFACE, lat: -28.1862, lon: -14.2077, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'maybe another corner...'},
            {goal: DGOAL.SURFACE, lat: -28.1851, lon: -14.2088, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'egres'},
            {goal: DGOAL.SURFACE, lat: -28.1848, lon: -14.2108, min_alt: 20, min_dist: 0.045, body_id: 'kivah@2690:41:356/a 2', name: 'almost there!'},
        ]
    },
    {
        _id: 'CCN_COLONIA_7AA',
